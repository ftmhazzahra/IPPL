...
<body class="bg-white transition-colors duration-300">
    ...
    <header class="w-full sticky top-0 z-50">
        <nav class="w-full bg-indigo-500 shadow-lg rounded-b-2xl flex items-center justify-between h-20 px-8 sm:px-12 lg:px-24 transition-all duration-300">
            <div class="flex items-center space-x-4">
                ...
                <span class="text-2xl font-bold text-white tracking-tight" style="font-family: 'Dancing Script', cursive, 'Inter', sans-serif;">
                    Explore Scholar
                </span>
            </div>
    ...
    <!-- Main Content -->
    <main class="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 mt-20 text-gray-900 transition-colors duration-300">
        @yield('content')
    </main>
